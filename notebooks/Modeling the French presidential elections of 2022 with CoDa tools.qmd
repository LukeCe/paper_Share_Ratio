...
clr_confint$Y <- factor(rename_elec[clr_confint$Y],levels = c("Mean elasticity", rev(rename_elec)))
clr_confint_all <- clr_confint
clr_confint_all$Y <- factor("Mean elasticity", levels(clr_confint_all$Y))
...
ggsave(here("out/figures", "clrB_profcat.pdf"), height = 4, width = 7)
```
